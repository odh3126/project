 ...
 * 
 * 		2.	GIT 공부하기	(GIT 설치 / 소스트리 설치)																	* GITHUB 연동 완료
 * 
 * 		3. GIT 개념 이해하기															
 * 			소스트리를 활용한 GIT 사용하기																				* 소스트리 연동 완료 ( ID : imjinsan) 
 * 			
 * 			clone과 pull의 개념 이해하기																						*
 * 
 * 			clone	:	복제 .git 이라는 하위 디렉토리를 만듬.
 * 
 * 			pull		:	GIT에 저장된 소스를 가져오는 행위
 * 			 
 */
